...
export const BookingInfoModal = ({open, onClose, onConfirm}: BookingInfoModalProps) => {
    ...
    const checkPhone = (value: string) => {
        ...
        if (!trimmed) {
            ...
            setPhoneError("Số điện thoại phải bắt đầu bằng số 0 và có độ dài hợp lệ.");
        } else {
            setPhoneError("");
        }
    };
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent>
                ...
                <div className="space-y-4">
                    ...
                    />
                    <p className={`text-xs mt-2 min-h-[16px] ${(nameError || phoneError) ? 'text-red-500' : 'text-transparent'}`}>
