    ...
    return (
        ...
        <div className="m-4">
            <Table className="border-separate border-spacing-0 text-center whitespace-nowrap w-full">
                <TableHeader>
                    <TableRow>
                        <TableHead className="sticky left-0 z-20 bg-white border-l border-r border-t border-b border-gray-600 px-4 py-2 text-center">
                            Tên sân
                        </TableHead>
                ...
                <TableBody>
                    {Object.entries(courts).map(([courtId, court]) => (
                        <TableRow key={courtId}>
                            <TableCell className="sticky left-0 z-20 bg-white border-l border-r border-t border-b border-gray-600 px-4 py-2 text-center">
                                {court.name}
                            </TableCell>
