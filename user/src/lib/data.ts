export const websites = {
  ...
  sources: {
    base: {
      type: "vector",
      url: "https://tiles.goong.io/sources/base.json?api_key=4OHpIqkyMpzce0ccJOik3ldyQSrTrwzBmp7XrlVX",
    },
    composite: {
      type: "vector",
      url: "https://tiles.goong.io/sources/goong.json?api_key=4OHpIqkyMpzce0ccJOik3ldyQSrTrwzBmp7XrlVX",
    },
  },
  sprite: "https://tiles.goong.io/sprite",
  glyphs:
    "https://tiles.goong.io/fonts/{fontstack}/{range}.pbf?api_key=4OHpIqkyMpzce0ccJOik3ldyQSrTrwzBmp7XrlVX",
  layers: [
    {
      id: "background",
      type: "background",
    ...
    },
    {
      ...
      layout: { visibility: "visible" },
      paint: { "fill-color": "rgba(206, 206, 209, 1)", "fill-opacity": 0.6 },
    },
    {
      id: "water-shadow",
      type: "fill",
    ...
    },
    {
      ...
      minzoom: 12,
      maxzoom: 24,
      filter: ["all", ["==", "class", "major"], ["==", "structure", "tunnel"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      minzoom: 11,
      maxzoom: 24,
      filter: ["all", ["==", "class", "street"], ["==", "structure", "tunnel"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      "source-layer": "streets",
      maxzoom: 24,
      filter: ["all", ["==", "class", "trunk"], ["==", "structure", "tunnel"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      minzoom: 12,
      maxzoom: 24,
      filter: ["all", ["==", "class", "service"], ["==", "structure", "road"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      "source-layer": "streets",
      minzoom: 7,
      filter: ["all", ["==", "structure", "road"], ["==", "class", "primary"]],
    ...
    },
    {
      ...
      "source-layer": "streets",
      maxzoom: 24,
      filter: ["all", ["==", "class", "motorway"], ["==", "structure", "road"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      minzoom: 7,
      maxzoom: 24,
      filter: ["all", ["==", "class", "primary"], ["==", "structure", "road"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      minzoom: 12,
      maxzoom: 24,
      filter: ["all", ["==", "class", "major"], ["==", "structure", "bridge"]],
      layout: {
        "line-cap": "round",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      "source-layer": "streets",
      maxzoom: 24,
      filter: ["all", ["==", "class", "trunk"], ["==", "structure", "bridge"]],
      layout: {
        "line-cap": "butt",
        "line-join": "round",
        visibility: "visible",
    ...
    },
    {
      ...
      minzoom: 9,
      maxzoom: 13,
      filter: ["all", ["==", "type", "neighbourhood"], ["==", "scalerank", 2]],
      layout: {
        "text-font": ["Roboto Medium"],
        "text-size": {
          base: 1.2,
    ...
    },
    {
      ...
      minzoom: 9,
      maxzoom: 15,
      filter: ["all", ["==", "type", "neighbourhood"], ["==", "scalerank", 1]],
      layout: {
        "text-font": ["Roboto Medium"],
        "text-size": {
          base: 1.2,
  ...
  attribution:
    '<a href=styles"https://goong.io/" target="_blank">&copy; Goong.io</a>',
